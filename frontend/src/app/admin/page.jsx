...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="h-full flex overflow-hidden bg-obsidian">
      {/* Content Area */}
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        {/* Simplified Admin Top Header */}
        <header className="h-[70px] w-full flex items-center justify-between px-6 border-b border-glass-border bg-obsidian/40 backdrop-blur-md">
          <div className="flex items-center gap-2">
